...
public interface PartitionedNetworkClient<PartitionedId> extends BaseNetworkClient {
  ...
  /**
   * Sends a <code>Message</code> to all replicas for the specified <code>PartitionedId</code>. The <code>PartitionedNetworkClient</code>
   * will interact with the current <code>PartitionedLoadBalancer</code> to calculate all the nodes serve the partitionedId. This method
   * is asynchronous and will return immediately
   *
   * @return  <code>ResponseIterator</code>. One response will be returned by each <code>Node</code>
   * the message was sent to.
   * @throws InvalidClusterException thrown if the cluster is currently in an invalid state
   * @throws NoNodesAvailableException thrown if the <code>PartitionedLoadBalancer</code> was unable to provide a <code>Node</code>
   * to send the request to
